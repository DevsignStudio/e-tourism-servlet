 ...
 * @author Lili Madiha
 */
@WebServlet(name = "PublicController", urlPatterns = {"", "/login.jsp", "/register.jsp"})
...
//        System.out.println(request.getServletPath());
        ...
        } else if (request.getServletPath().equals("/register.jsp")) {
            page = request.getServletPath();
        }
        
        sendPage(request, response, "/WEB-INF" + page);
    }
